...
const ENERGY_COST_MULTIPLIER = 0.2;
const ENERGY_MOVE_PER_SECOND = 2.3 * ENERGY_COST_MULTIPLIER;
const ENERGY_SPRINT_EXTRA_PER_SECOND = 1.5 * ENERGY_COST_MULTIPLIER;
const ENERGY_SHOT_COST = 11 * ENERGY_COST_MULTIPLIER;
const ENERGY_DYNAMITE_COST = 28 * ENERGY_COST_MULTIPLIER;
const ENERGY_BEARING_COST = 17 * ENERGY_COST_MULTIPLIER;
const ENERGY_CIWS_ROUND_COST = 0.04 * ENERGY_COST_MULTIPLIER;
const ENERGY_ANTI_AIR_COST = 24 * ENERGY_COST_MULTIPLIER;
const ENERGY_NUCLEAR_COST = 46 * ENERGY_COST_MULTIPLIER;
