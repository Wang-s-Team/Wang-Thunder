...
const elements = {
  ...
  tutorialTrainer: document.querySelector("#tutorial-trainer"),
  tutorialRange: document.querySelector("#tutorial-range"),
  tutorialAvatar: document.querySelector("#tutorial-avatar"),
  tutorialTarget: document.querySelector("#tutorial-target"),
  tutorialReticle: document.querySelector("#tutorial-reticle"),
  tutorialSpeedometer: document.querySelector("#tutorial-speedometer"),
  tutorialMissile: document.querySelector("#tutorial-missile"),
  ...
  tutorialEnergyText: document.querySelector("#tutorial-energy-text"),
  tutorialEnergyFill: document.querySelector("#tutorial-energy-fill"),
  tutorialTargetText: document.querySelector("#tutorial-target-text"),
  tutorialTargetFill: document.querySelector("#tutorial-target-fill"),
  tutorialChecks: document.querySelector("#tutorial-checks"),
  tutorialReset: document.querySelector("#tutorial-reset"),
  tutorialStartGame: document.querySelector("#tutorial-start-game"),
